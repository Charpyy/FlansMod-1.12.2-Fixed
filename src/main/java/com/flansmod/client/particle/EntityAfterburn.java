...
public class EntityAfterburn extends Particle
{
    ...
    public void renderParticle(float par2, float par3, float par4, float par5, float par6, float par7)
    {
        ...
        worldrenderer.tessellator.getBuffer().color(this.particleRed * (colorIntensity - this.particleAge*0.2F), this.particleGreen * (colorIntensity - this.particleAge*0.2F), this.particleBlue * colorIntensity, (1F - this.particleAge*0.1F));
