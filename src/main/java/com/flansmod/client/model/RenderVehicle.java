		...
		GlStateManager.pushMatrix();
		{
			...
			GlStateManager.pushMatrix();
			{
				...
				if(modVehicle != null)
				{
					...
					GlStateManager.pushMatrix();
					GlStateManager.translate(modVehicle.doorAttach.x + newPos.x/16, modVehicle.doorAttach.y + newPos.y/16, -modVehicle.doorAttach.z + newPos.z/16);
					GlStateManager.rotate(newRot.x, 1F, 0F, 0F);
					GlStateManager.rotate(-newRot.y, 0F, 1F, 0F);
					GlStateManager.rotate(newRot.z, 0F, 0F, 1F);
					...
					GlStateManager.pushMatrix();
					GlStateManager.translate(modVehicle.door2Attach.x + newPos2.x/16, modVehicle.door2Attach.y + newPos2.y/16, -modVehicle.door2Attach.z + newPos2.z/16);
					GlStateManager.rotate(newRot2.x, 1F, 0F, 0F);
					GlStateManager.rotate(-newRot2.y, 0F, 1F, 0F);
					GlStateManager.rotate(newRot2.z, 0F, 0F, 1F);
